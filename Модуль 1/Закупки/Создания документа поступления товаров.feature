...
Как Менеджер по закупкас я хочу
создание документа поступления товароа
чтобы поставить товар на учет 

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: 01 Создание документа поступления товаров
//  создание документа
...
* Проверка заполнения табличной части
	...
	// 	| 'Торт ' | '78Т'     | '150,00' | '10,00'      | '1 500,00' |
	И я нажимаю на кнопку "Записать"
* Номер 
...
Сценарий: 02 Проверка наличия в справочнике номенклатуры "Торт"
